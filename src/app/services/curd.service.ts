...
export class CurdService {
  ...
  postcustomize(obj: any): Observable<any> {
    ...
    return this.http.post(`${environment.apiUrl}/CustomizedJewellers/AddCustomizedJeweller`, obj)


  }
  uploadJeweller(obj: any): Observable<any> {

    return this.http.post(`${environment.apiUrl}/CustomizedJewellers/UploadCustomizedJeweller`, obj)


  }

  AddPhotoJeweller(obj: any): Observable<any> {

    return this.http.post(`${environment.apiUrl}/ProductDetails/AddPhotoJeweller`, obj)
  ...
  postcustomplatinum(obj: any): Observable<any> {

    return this.http.post(`${environment.apiUrl}/ProductDetails/AddCustomplatinum`, obj)
  }

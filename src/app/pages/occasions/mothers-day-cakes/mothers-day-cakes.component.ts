...
export class MothersDayCakesComponent  {
  constructor(private titleService: Title, private meta: Meta, private renderer: Renderer2)
  {
    ...
    this.meta.updateTag({ name: 'description', content: 'Order cakes online from Sri Datta to celebrate Mother’s Day and have them delivered across India the same day or at midnight. We offer a variety of cakes that are sure to delight every mom. Order Mother’s Day cakes online and surprise your mom!' });

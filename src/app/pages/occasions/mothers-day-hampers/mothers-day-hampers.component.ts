...
export class MothersDayHampersComponent  {
  constructor(private titleService: Title, private meta: Meta) {
    ...
    this.meta.updateTag({name: 'description', content: 'Order Mothers Day Hampers online from Sri Datta and have them delivered across India the same day and midnight.Our hampers are filled with sweet treats, thoughtful gifts, and beautiful flowers, perfect for showing your love for your mom.Order Mother’s Day hampers online and surprise your mom!' });

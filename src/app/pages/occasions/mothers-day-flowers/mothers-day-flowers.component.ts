...
export class MothersDayFlowersComponent  {
  constructor(private titleService: Title, private meta: Meta) {
    ...
    this.meta.updateTag({name: 'description', content: 'Order Mothers Day flowers online from Sri Datta and have them delivered across India the same day or at midnight.We offer a variety of personalized bouquets and other unique gifting categories.Order Mother’s Day flowers online and surprise your mom!' });

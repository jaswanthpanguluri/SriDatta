...
export class FranchisesComponent {
  ...
  constructor(
    ...
    this.titleService.setTitle('Jewellers, Florist Shop Franchise Business Opportunities | Sri Dutta');
    this.meta.updateTag({ name: 'description', content: 'Sri Datta offer Jewellers, florist, combos, confectionery and gift shop Franchise Business opportunities in India - Inquire for low-cost.' });
    this.meta.updateTag({ name: 'keywords', content: 'Sri Datta-CouponPartnersJewellers, florist, combos, platinum, confectionery' });
    this.meta.updateTag({ name: 'classification', content: 'Sri Datta offer Jewellers, florist, combos, confectionery and gift shop Franchise Business opportunities in India - Inquire for low-cost.' });

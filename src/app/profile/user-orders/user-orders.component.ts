...
export class UserOrdersComponent implements OnInit {
  ...
  {
    this.titleService.setTitle("SriDutta's - My Orders");
    this.meta.updateTag({ name: 'description',  content: "SriDutta's - My Orders" });
    this.meta.updateTag({ name: 'keywords',  content: "SriDutta's - My Orders" });
    this.meta.updateTag({ name: 'classification',  content:"SriDutta's - My Orders" });

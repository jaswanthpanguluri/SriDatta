...
export class UserDashboardComponent {
  ...
  constructor(private cookieService: CookieService, private titleService: Title, private meta: Meta, private _curdService: CurdService, private route: Router) {
    ...
    this.titleService.setTitle("SriDutta's - My Account");
    this.meta.updateTag({ name: 'description', content: "SriDutta's - My Account" });
    this.meta.updateTag({ name: 'keywords', content: "SriDutta's - My Account" });
    this.meta.updateTag({ name: 'classification', content: "SriDutta's - My Account" });

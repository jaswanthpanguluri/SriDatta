...
export class UserProfileComponent implements OnInit{
  ...
  {
    this.titleService.setTitle("SriDutta's - My Profile");
    this.meta.updateTag({ name: 'description',  content: "SriDutta's - My Profile" });
    this.meta.updateTag({ name: 'keywords',  content: "SriDutta's - My Profile" });
    this.meta.updateTag({ name: 'classification',  content:"SriDutta's - My Profile" });
